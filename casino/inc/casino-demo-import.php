...
function casino_import_files() {
	return array(
		array(
			'import_file_name'             => 'Casino Demo',
			//'categories'                   => array( 'Category 1', 'Category 2' ),
			'local_import_file'            => trailingslashit( get_template_directory() ).'/demo-data/casino-content.xml',
...
add_filter( 'ocdi/import_files', 'casino_import_files' );